...
/**
 * Acceptance Criterion: RegionLoader registers YamlHelpers registry as a service
 */
#[Group('loader'), Group('feature-registration')]
class YamlHelpersRegistrationTest extends TestCase
{
    public function testRegistersYamlHelpersRegistry(): void
    {
        // Arrange
        ...
        // Assert
        $registry = $chainMail->get(YamlHelpers::class);
        $this->assertInstanceOf(YamlHelpers::class, $registry);
    }
}
