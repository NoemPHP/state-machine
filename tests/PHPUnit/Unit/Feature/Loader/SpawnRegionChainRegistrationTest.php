...
/**
 * Acceptance Criterion: RegionLoader registers SpawnRegion chain as a service
 */
#[Group('loader')]
#[Group('feature-registration')]
class SpawnRegionChainRegistrationTest extends TestCase
{
    public function testRegistersSpawnRegionChain(): void
    {
        ...
        $spawnRegion = $chainMail->get(SpawnRegion::class);

        $this->assertInstanceOf(SpawnRegion::class, $spawnRegion);
    }
}
