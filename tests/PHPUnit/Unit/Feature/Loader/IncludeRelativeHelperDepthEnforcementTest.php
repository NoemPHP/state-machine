...
/**
 * Acceptance Criterion: IncludeRelativeHelper throws RuntimeException when recursion depth exceeds MAX_INCLUDE_DEPTH
 */
#[Group('loader'), Group('include-helpers')]
class IncludeRelativeHelperDepthEnforcementTest extends TestCase
{
    public function testThrowsExceptionWhenDepthExceedsLimit(): void
    {
        ...
        $loadFile->method('call')->willReturn('nested: !includeRelative next.yaml');
