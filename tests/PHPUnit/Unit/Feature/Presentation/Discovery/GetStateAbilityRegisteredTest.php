...
class GetStateAbilityRegisteredTest extends TestCase
{
    public function testGetPresentedStateAbilityIsRegistered(): void
    {
        ...
        $this->assertNotNull($registry->get('get-presented-state'));
    }
}
