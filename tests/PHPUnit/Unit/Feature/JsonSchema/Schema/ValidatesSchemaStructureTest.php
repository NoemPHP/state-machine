...
/**
 * Acceptance Criteria: Schema validates context.schema structure at YAML load time
 * Intent: Catches schema definition errors during build phase, failing fast before execution
 * Criticality: constraint
 */
final class ValidatesSchemaStructureTest extends TestCase
{
    public function testSchemaValidatesStructure(): void
    {
        ...
        // Verify that valid schema structure is accepted
        ...
        $this->assertCount(1, $normalized->context->schema);
    }
}
