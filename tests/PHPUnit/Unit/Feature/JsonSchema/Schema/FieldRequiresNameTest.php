...
/**
 * Acceptance Criteria: Schema field definition requires name as string property
 * Intent: Uniquely identifies context field for validation and initialization
 * Criticality: contract
 */
final class FieldRequiresNameTest extends TestCase
{
    public function testSchemaFieldRequiresName(): void
    {
        ...
        // Test that field with name passes validation
        ...
        $this->assertEquals('validField', $schema[0]['name']);
    }
}
