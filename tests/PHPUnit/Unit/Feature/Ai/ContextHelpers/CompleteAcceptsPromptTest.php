 ...
 */
class CompleteAcceptsPromptTest extends TestCase
{
    public function testCompleteMethodAcceptsPromptStringAsFirstParameter(): void
    {
        $chainMail = new ChainMail();
        $feature = new AiFeature();

        // AiFeature should register complete() method handler
        $feature($chainMail);
