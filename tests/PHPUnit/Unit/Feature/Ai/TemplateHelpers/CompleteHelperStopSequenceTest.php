...
/**
 * Acceptance Criterion: Complete helper accepts stop sequence parameter
 */
#[Group('ai'), Group('template-helpers')]
class CompleteHelperStopSequenceTest extends TestCase
{
    #[Test]
    public function completeHelperStopSequenceTest(): void
    {
        /**
         * ======================================================================
