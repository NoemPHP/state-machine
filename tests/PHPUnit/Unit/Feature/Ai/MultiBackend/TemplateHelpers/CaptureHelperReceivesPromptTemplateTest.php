...
/**
 * Acceptance Criterion: Capture helper receives PromptTemplate chain via ChainMail injection
 *
 * Intent: Obtains prompt template resolver through dependency injection
 */
#[Group('ai'), Group('enhanced-template-helpers')]
class CaptureHelperReceivesPromptTemplateTest extends TestCase
{
    #[Test]
