 ...
 */
final class RegionLevelKeyTest extends RegionBuilderTestCase
{
    public function testAbilitiesKeySupportedAtRegionLevel(): void
    {
        $config = [
            'abilities' => [
                [
        ...
        // If abilities key is not supported, this will throw schema validation error
    }
}
