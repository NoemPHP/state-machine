...
class BoundAccessRegisterStoresInRegistryTest extends TestCase
{
    public function testBoundAccessRegisterInteractionStoresDefinitionInRegionsInteractionRegistry(): void
    {
        ...
        $builder->onEnter('ready', function (object $trigger): void {
        ...
        $retrieved = $registry->get('runtime_confirm');

        $this->assertNotNull($retrieved);
        $this->assertSame('confirm', $retrieved->type);
        $this->assertSame('Continue?', $retrieved->question);
    }
}
