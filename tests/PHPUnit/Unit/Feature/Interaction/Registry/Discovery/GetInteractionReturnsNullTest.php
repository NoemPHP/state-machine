...
class GetInteractionReturnsNullTest extends TestCase
{
    public function testGetInteractionAbilityReturnsNullWhenIdDoesNotExist(): void
    {
        ...
        $result = ($ability->handler)(['id' => 'nonexistent']);
