...
class GetByStateAbilityRegisteredTest extends TestCase
{
    public function testAbilityRegistryContainsGetInteractionsForStateAbilityAfterFeatureLoads(): void
    {
        ...
        $ability = $registry->get('get-interactions-for-state');
        $this->assertNotNull($ability);
        $this->assertSame('get-interactions-for-state', $ability->name);
    }
}
