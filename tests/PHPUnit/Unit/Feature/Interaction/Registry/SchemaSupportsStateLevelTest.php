...
class SchemaSupportsStateLevelTest extends TestCase
{
    public function testRegionLoaderSchemaSupportsInteractionsKeyAtStateLevel(): void
    {
        $schema = new Schema();
        ...
        // Verify interactions key is supported at state level (schema was extended)
        $this->assertNotNull($context->state);
    }
}
